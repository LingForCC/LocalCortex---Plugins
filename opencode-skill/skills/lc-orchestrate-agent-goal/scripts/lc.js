/*
 * lc.js — JXA helper for the LocalCortex `lc-orchestrate-agent-goal` skill.
 *
 ...
 * client-side filters used by the LocalCortex skills (the app has no
 * name/worker-search command of its own); `tasks-get`,
...
// Match agent-owned tasks by stable agent id.
