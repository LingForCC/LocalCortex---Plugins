...
description: >-
  ...
  recurring schedule — e.g. "work one opencode task on Build", "have the agent
  ...
  recurring job and does not chain sibling skills.
license: MIT
...
say so and leave it `in_progress`. No recurring job is created by this skill,
