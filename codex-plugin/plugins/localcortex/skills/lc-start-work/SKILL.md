...
description: >-
  ...
  recurring Codex scheduled task and does not chain sibling skills.
---
...
does **not** create a recurring Codex scheduled task.
...
group just finished, the report ends with the parent close-out line (Step 6). No scheduled task is created
